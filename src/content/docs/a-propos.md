...
Le dépôt suit la rédaction du cours : à ce jour, les tests couvrent les **parties 3 à 11**. À partir de la partie 5, les tests ont besoin de PostgreSQL, et à partir de la partie 10 de Redis : `docker compose up -d` (ou Podman) lance les deux, ceux du dépôt.
