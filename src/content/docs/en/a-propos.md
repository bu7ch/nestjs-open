...
The repository follows the writing of the course: as of now, the tests cover **parts 3 to 11**. From part 5 on, the tests need PostgreSQL, and from part 10 on Redis: `docker compose up -d` (or Podman) starts the repository's two.
